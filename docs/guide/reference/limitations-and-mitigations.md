...
|---|---|---|
| Enable the shipped neural router; add task-class/tool-calling escalation signal | §1, §2 | ✅ **shipped** — [`config/routing/router-policy.example.json`](../../../config/routing/router-policy.example.json) + [Tiers & Routing §1/§2](tiers-and-routing.md#-strengthening-the-routing-signal-1-2) |
