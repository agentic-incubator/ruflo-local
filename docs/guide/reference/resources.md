...
|---|---|
| **Bifrost** (Go, open-source, self-hosted) — https://github.com/maximhq/bifrost | You want µs-class gateway overhead, native OTel, and no Python/Postgres footprint — **shipped as an activatable variant, `make gateway-up PROFILE=bifrost`** → [Gateway Variants](gateway-variants.md) |
